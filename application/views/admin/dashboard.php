                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span> <?php echo $profil->username; ?> <i class="caret"></i></span>
                            </a>
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>administrator/dashboard/operator">
                                <i class="fa fa-wifi"></i> <span>Operator</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>administrator/dashboard/paket_pulsa">
                                <i class="fa fa-tags"></i> <span>Paket Pulsa</span>
                            </a>
                        </li>
                         <li>
                            <a href="<?php echo base_url(); ?>administrator/dashboard/transaksi">
                                <i class="fa fa-line-chart"></i> <span>Transaksi Order</span>
                            </a>
                        </li>
                        <li>
                         ...
                         <li>
                            <a href="<?php echo base_url(); ?>administrator/dashboard/admin">
